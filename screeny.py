...
class Screeny:
    ...
    def __init__(self, config: ScreenshotConfig):
        ...
        self._playwright_ctx = None # Store the async_playwright context manager
        
    async def __aenter__(self):
        """Async context manager entry"""
        self._playwright_ctx = async_playwright()
        self.playwright = await self._playwright_ctx.__aenter__()
    ...
    async def __aexit__(self, exc_type, exc_val, exc_tb):
        ...
        if self._playwright_ctx:
            await self._playwright_ctx.__aexit__(exc_type, exc_val, exc_tb)
